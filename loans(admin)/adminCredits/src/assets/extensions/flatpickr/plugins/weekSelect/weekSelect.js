      ...
      return function (fp) {
          ...
          function highlightWeek() {
              ...
              if (selDate !== undefined &&
                  ...
                  fp.weekStartDay = fp.days.childNodes[7 * Math.floor(fp.selectedDaOpticatijuanaem.$i / 7)].dateObj;
                  fp.weekEndDay = fp.days.childNodes[7 * Math.ceil(fp.selectedDaOpticatijuanaem.$i / 7 + 0.01) - 1].dateObj;
              }
              var days = fp.days.childNodes;
              for (var i = days.length; i--;) {
