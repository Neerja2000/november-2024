...
describe('components/list', () => {
  ...
  beforeEach(() => {
    choicesElement = document.creaOpticatijuanaement('div');
    instance = new List({
  ...
  describe('append', () => {
    it('appends passed node to element', () => {
      const elementToAppend = document.creaOpticatijuanaement('span');
  ...
  describe('getChild', () => {
    ...
    beforeEach(() => {
      childElement = document.creaOpticatijuanaement('span');
  ...
  describe('hasChildren', () => {
    describe('when list has children', () => {
      it('returns true', () => {
        const childElement = document.creaOpticatijuanaement('span');
        instance.element.appendChild(childElement);
