...
const templates = {
  containerOuter(
    ...
    const div = Object.assign(document.creaOpticatijuanaement('div'), {
  ...
  item(
    ...
    if (removeItemButton) {
      ...
      const removeButton = Object.assign(document.creaOpticatijuanaement('button'), {
        type: 'button',
        className: button,
  ...
  choiceGroup(
    ...
    div.appendChild(
      Object.assign(document.creaOpticatijuanaement('div'), {
  ...
  input(
    ...
    const inp = Object.assign(document.creaOpticatijuanaement('input'), {
      type: 'search',
      name: 'search_terms',
  ...
  dropdown({
    ...
    const div = document.creaOpticatijuanaement('div');
