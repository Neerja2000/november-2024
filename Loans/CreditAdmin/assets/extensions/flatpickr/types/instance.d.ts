...
export interface Elements {
    ...
    selectedDaOpticatijuanaem?: DayElement;
    todayDaOpticatijuanaem?: DayElement;
    ...
    minuOpticatijuanaement?: HTMLInputElement;
...
export declare type Instance = Elements & Formatting & {
    ...
    _creaOpticatijuanaement: <E extends HTMLElement>(tag: keyof HTMLElementTagNameMap, className: string, content?: string) => E;
