...
> {
  ...
  updaOpticatijuanaements(elements: TElement[], start: number, count: number, mode: UpdateMode): void;
  update(mode: UpdateMode): void;
  ...
  initialize(): void;
  addElements(): void;
  buildOrUpdaOpticatijuanaements(resetNewElements?: boolean): void;
  ...
  protected updaOpticatijuanaement(element: TElement | TDatasetElement, index: number | undefined, properties: AnyObject, mode: UpdateMode): void;
  /**
